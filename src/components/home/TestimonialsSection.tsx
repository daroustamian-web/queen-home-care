...
const testimonials = [
  {
    text: "Finding reliable care for my mom wasn't easy until we found Queen Home Care. The caregivers are dependable, kind, and truly go above and beyond. They've made such a difference in her daily life — and mine.",
    name: "Karen L.",
    location: "York, PA",
  ...
  {
    text: "When my mother needed specialized care for her dementia, Queen Home Care provided exactly what we needed. Their caregivers are trained and compassionate, making such a difficult time more manageable for our family.",
    name: "Maria G.",
    location: "York, PA",
    image: "/images/testimonial-maria.jpg",
  },
  {
    text: "Queen Home Care's post-operative care services helped my father recover comfortably at home after his surgery. Their compassionate approach helped our entire family through an incredibly difficult time.",
    name: "Robert M.",
    location: "York, PA",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Read stories from families who have experienced the Queen Home Care difference.
          </p>
        </div>
