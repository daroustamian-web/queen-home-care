    ...
    <section className="py-20 lg:py-28 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h4 className="font-heading text-xl font-semibold mb-6">Why Refer to Queen Home Care?</h4>
            <div className="space-y-6">
              {[
                ...
                { title: "Local Service You Can Trust", desc: "We value your trust and confidence in our services. Ask about our referral appreciation program for families in York, PA." },
              ].map((item) => (
