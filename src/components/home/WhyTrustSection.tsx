...
const reasons = [
  ...
  },
  {
    ...
    description: "Dedicated to serving York and surrounding areas with reliable, consistent home care services.",
  },
  {
    icon: Heart,
    ...
    <section className="py-20 lg:py-28 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
          Why Families{" "}
          <span className="text-muted-foreground">Trust Queen Home Care</span>
        </h2>
