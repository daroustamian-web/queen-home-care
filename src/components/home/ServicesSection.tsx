      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            At Queen Home Care, we offer a comprehensive range of personalized care services designed to meet your unique needs and enhance your quality of life in the comfort of your own home.
          </p>
        </div>
        ...
        <div className="mt-16 bg-primary rounded-2xl p-8 md:p-12 text-center text-primary-foreground">
          ...
          <p className="text-primary-foreground/80 mb-6 max-w-xl mx-auto">
            Discover how we can help your loved one live independently and comfortably at home. Call us at 484-545-7410 or email us at bflores@queenhomecare.us to get started.
          </p>
