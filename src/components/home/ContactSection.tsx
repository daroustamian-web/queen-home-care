    ...
    <section id="contact" className="py-20 lg:py-28 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Ready to learn more about our home care services? Contact Queen Home Care today for a free consultation.</p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-5 rounded-xl bg-secondary">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary">bflores@queenhomecare.us</p>
              ...
              <div className="flex gap-4 p-5 rounded-xl bg-secondary">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary">484-545-7410</p>
              ...
              <div className="flex gap-4 p-5 rounded-xl bg-secondary">
                ...
                <div>
                  ...
                  <p className="text-sm">York and surrounding areas</p>
