    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src="/images/logo.png" alt="Queen Home Care" className="h-10 w-auto" />
            ...
            <p className="text-sm opacity-70 leading-relaxed mb-5">
              Providing reliable care for your peace of mind in York and surrounding areas. Bringing compassionate caregivers to your doorstep with dignity, respect, and genuine human connection.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm opacity-70">
              <div className="flex items-start gap-3">
                ...
                <span>York, PA - York</span>
              </div>
              <div className="flex items-start gap-3">
                <Phone className="h-4 w-4 mt-0.5 shrink-0" />
                <a href="tel:484-545-7410" className="hover:opacity-100 transition-opacity">484-545-7410</a>
              </div>
              <div className="flex items-start gap-3">
                <Mail className="h-4 w-4 mt-0.5 shrink-0" />
                <a href="mailto:bflores@queenhomecare.us" className="hover:opacity-100 transition-opacity">bflores@queenhomecare.us</a>
              </div>
            </div>
        ...
        <div className="border-t border-background/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 max-w-4xl mx-auto">
            <div className="text-center md:text-left">
              <h4 className="font-heading text-lg font-semibold mb-1">Stay Connected with Queen Home Care</h4>
        ...
        <div className="border-t border-background/20 mt-8 pt-8 text-center text-sm opacity-50">
          <p>&copy; 2024 Queen Home Care. All rights reserved.</p>
          <p className="mt-2 text-xs">Serving the areas of York and surrounding areas. Experts in providing compassionate in-home care.</p>
        </div>
      </div>
    </footer>
  );
