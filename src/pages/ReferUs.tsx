...
const faqs = [
  {
    q: "What home care services does Queen Home Care provide?",
  ...
  },
  {
    ...
    a: "We proudly serve York and surrounding areas. Our goal is to bring professional home care services directly to your doorstep throughout the region.",
  },
  {
    q: "Are your caregivers licensed and insured?",
    a: "Yes, all our caregivers are certified in home care services, thoroughly background-checked, and bonded. Queen Home Care is fully licensed and insured to provide peace of mind for you and your family.",
  },
  {
  ...
  },
  {
    ...
    a: "Our rates vary depending on the type and level of care needed. We accept private pay and work with families to explore all payment options to ensure you receive the care you need. Contact us at 484-545-7410 for a free consultation to discuss pricing.",
  },
  {
      ...
      <main>
        ...
        <section className="relative h-[400px] md:h-[480px] overflow-hidden">
          <img
            ...
            alt="Refer someone to Queen Home Care"
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                When you refer someone to Queen Home Care, you're connecting
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center p-6 bg-card border border-border rounded-xl">
                ...
                <a
                  href="mailto:bflores@queenhomecare.us"
                  className="text-sm text-primary hover:underline"
                >
                  bflores@queenhomecare.us
                </a>
              </div>
              <div className="flex flex-col items-center text-center p-6 bg-card border border-border rounded-xl">
                <div className="w-10 h-10 rounded-full bg-primary-light flex items-center justify-center mb-3">
