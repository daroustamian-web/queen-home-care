    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative h-[400px] md:h-[480px] overflow-hidden">
          <img src="/images/hero-couple.jpg" alt="About Queen Home Care" className="w-full h-full object-cover" />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-primary-foreground max-w-2xl px-4">
              ...
              <p className="opacity-80 leading-relaxed">
                At Queen Home Care, we bring compassionate, personalized care right to your home — because you deserve to feel safe, comfortable, and cared for where you feel most at ease. Our carefully screened caregivers proudly serve families throughout York.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-lg leading-relaxed mb-6">
                At Queen Home Care, we know that choosing a home care provider is about more than services — it's about trust, compassion, and peace of mind. Our mission is simple: to provide reliable, personalized care that allows our clients to live safely, comfortably, and with dignity in the place they call home.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Each member of our team is chosen not only for their experience, but also for their kindness, dedication, and genuine passion for helping others. You can trust that your loved one will receive respectful, dependable, and compassionate care every step of the way. We are proudly serving families throughout York, PA and surrounding areas.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="rounded-2xl overflow-hidden">
                <img src="/images/about-caregiver.jpg" alt="Queen Home Care caregiver with client" className="w-full h-[400px] object-cover" />
              </div>
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our team of skilled caregivers is dedicated to treating every client like family — with patience, respect, and a commitment to excellence. Serving families in York, PA - York, we are proud to be a trusted partner for clients and their loved ones.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  At Queen Home Care, we hold ourselves to the highest standards so you can have complete confidence in the care your loved one receives.
                </p>
              ...
              <div className="rounded-2xl overflow-hidden">
                <img src="/images/respite-care.jpg" alt="Queen Home Care commitment to excellence" className="w-full h-[400px] object-cover" />
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8 text-center max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-lg opacity-80 mb-10 leading-relaxed">
                Let Queen Home Care help you or your loved one maintain independence and dignity at home.
              </p>
